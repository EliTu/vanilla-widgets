import { HttpResult, UrlParams } from './interfaces';
import buildUrl from './utils/buildUrl';
import { generateRecommendationItemByOrigin, generateWidgetSectionByOrigin } from './elements/widgetContentElements';
